...
# this line gives an import error.
import datasets
...
flags.DEFINE_boolean('encode_valid', True, 'Whether to encode and store the validation set.')
...
flags.DEFINE_integer('weight_images', 16, 'Number of weight images to generate.')
